...
void GpConfigLoad(GpProxyConfig* cfg) {
...

    {
        ...
        h.wagonEnable          = ReadBool (ini, L"Haptics", L"WagonEnable",          h.wagonEnable);
        h.wagonGain            = ReadFloat(ini, L"Haptics", L"WagonGain",            h.wagonGain);
        h.wagonMinPeriodMs     = ReadInt  (ini, L"Haptics", L"WagonMinPeriodMs",     h.wagonMinPeriodMs);
        h.wagonMaxPeriodMs     = ReadInt  (ini, L"Haptics", L"WagonMaxPeriodMs",     h.wagonMaxPeriodMs);
        h.wagonSpeedLow        = ReadFloat(ini, L"Haptics", L"WagonSpeedLow",        h.wagonSpeedLow);
        h.wagonSpeedHigh       = ReadFloat(ini, L"Haptics", L"WagonSpeedHigh",       h.wagonSpeedHigh);
        h.wagonTrigGain        = ReadFloat(ini, L"Haptics", L"WagonTrigGain",        h.wagonTrigGain);
        h.wagonBodyBase        = ReadFloat(ini, L"Haptics", L"WagonBodyBase",        h.wagonBodyBase);
        h.trainRideEnable      = ReadBool (ini, L"Haptics", L"TrainRideEnable",      h.trainRideEnable);
        h.trainRideGain        = ReadFloat(ini, L"Haptics", L"TrainRideGain",        h.trainRideGain);
        h.trainRideMinPeriodMs = ReadInt  (ini, L"Haptics", L"TrainRideMinPeriodMs", h.trainRideMinPeriodMs);
        h.trainRideMaxPeriodMs = ReadInt  (ini, L"Haptics", L"TrainRideMaxPeriodMs", h.trainRideMaxPeriodMs);
        h.trainRideTrigGain    = ReadFloat(ini, L"Haptics", L"TrainRideTrigGain",    h.trainRideTrigGain);
        h.trainRideBodyBase    = ReadFloat(ini, L"Haptics", L"TrainRideBodyBase",    h.trainRideBodyBase);
        h.trainPassEnable      = ReadBool (ini, L"Haptics", L"TrainPassEnable",      h.trainPassEnable);
        h.trainPassGain        = ReadFloat(ini, L"Haptics", L"TrainPassGain",        h.trainPassGain);
        h.trainPassRadius      = ReadFloat(ini, L"Haptics", L"TrainPassRadius",      h.trainPassRadius);
        h.trainPassApproachRef = ReadFloat(ini, L"Haptics", L"TrainPassApproachRef", h.trainPassApproachRef);
        h.trainPassEnvMs       = ReadInt  (ini, L"Haptics", L"TrainPassEnvMs",       h.trainPassEnvMs);
